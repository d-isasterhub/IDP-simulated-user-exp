...
USER_INTRO = "Attached is an image that consists of two sub-images. The top of the given image displays "\
...
USER_PROFILING = "You think the model distinguishes the four possible species classes based on the following "\
    "features:\n"\
...
USER_QUESTION = "What bird species do you think did the XAI model predict for the image?"\
