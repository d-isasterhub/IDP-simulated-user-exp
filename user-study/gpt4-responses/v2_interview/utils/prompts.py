...
USER_INTRO = "Attached is an image of a bird augmented with a heatmap. The heatmap was generated by "\
    "an explainable artificial intelligence XAI model to predict the bird species. "
...
USER_QUESTION = "Based on these descriptions, what bird species do you think did the XAI model predict "\
    "for the image? Choose one of the following options:\n"\
    "- Crested Auklet\n"\
    "- Least Auklet\n"\
    "- Parakeet Auklet\n"\
    "- Rhinoceros Auklet\n"\
...
USER_INTRO_1 = "Attached is an image that consists of two sub-images. The top of the given image "\
    "displays the original image of a bird and the bottom displays the same image combined with "\
    "a heatmap that was generated by an explainable artificial intelligence (XAI) model to predict "\
    "the species. "
...
USER_QUESTION_1 = "Based on these descriptions, what bird species do you think did the XAI model predict "\
    "for the image? Choose one of the following options:\n"\
    "- Crested Auklet\n"\
    "- Least Auklet\n"\
    "- Parakeet Auklet\n"\
...
# USER_INTRO_3 = "Attached is an image that consists of two sub - images. The top of the given image "\
#     "displays the original image of a bird and the bottom displays the same image combined with a "\
#     "heatmap that was generated by an explainable artificial intelligence XAI model to predict the "\
#     "species. "

# USER_PROFILING_3 = "You think the model distinguishes the four possible species classes based on the "\
#     "following features if they are highlighted red by the heatmap: \n"\
#     "- Rhinoceros Auklets: HEATMAP_FEATURES_RA\n"\
#     "- Least Auklets: HEATMAP_FEATURES_LA\n"\
#     "- Parakeet Auklets: HEATMAP_FEATURES_PA\n"\
...
# USER_QUESTION_3 = "Based on the descriptions and the areas highlighted by the heatmap, what bird "\
#     "species do you think was predicted for the given image? For your answer, choose one of the "\
#     "following options: \n"\
#     "- Crested Auklet\n"\
#     "- Least Auklet\n"\
#     "- Parakeet Auklet\n"\
#     "- Rhinoceros Auklet\n"\
#     "First describe all areas of the bird that are highlighted by the heatmap. Finally, explain for "\
#     "each given bird description why it could be this bird species or why not. Conclude your answer "\
#     "by stating only the chosen option in the last line of your response. Keep the token limit low."

# USER_3 ="Attached is an image that consists of two sub-images. The top of the given image displays "\
#     "the original image of a bird and the bottom displays the same image combined with a heatmap "\
#     "that was generated by an explainable artificial intelligence (XAI) model to predict the species. "\
#     "You think the model distinguishes the four possible species classes based on the following "\
#     "features if they are highlighted red by the heatmap:\n"\
