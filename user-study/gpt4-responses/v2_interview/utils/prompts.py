...
USER_INTRO_ALT = "Attached is an image that consists of two sub-images. The top of the given image "\
    "displays the original image of a bird and the bottom displays the same image combined with a "\
    "heatmap that was generated by an explainable artificial intelligence model to explain the species "\
    "predicted for the image. "

USER_HEATMAP_ALT = "Describe what areas of the bird are highlighted in red by the heatmap. Keep the number of tokens low. "

USER_PROFILING_ALT = "You believe that the classification model distinguishes between four possible species "\
    "classes based on the following features: \n"\
    "- Rhinoceros Auklets: HEATMAP_FEATURES_RA\n"\
    "- Least Auklets: HEATMAP_FEATURES_LA\n"\
    "- Parakeet Auklets: HEATMAP_FEATURES_PA\n"\
...
USER_QUESTION_ALT = "Based on the descriptions and the areas highlighted by the heatmap, which bird "\
    "species do you think was predicted for the given image? Choose one of the following options "\
    "for your answer: \n"\
    "- Crested Auklet\n"\
    "- Least Auklet\n"\
    ...
    "Conclude your answer by stating only the selected option in the last line of your answer. Keep the number of tokens low."
