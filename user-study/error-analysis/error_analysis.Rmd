...
answer_differences <- table(results_dt$Same_Answer, results_dt$Neither_Correct)
...
full_dt %>% ggplot(aes(x=full_dt$Description, color=full_dt$Same_Answer, fill=full_dt$Same_Answer))+geom_bar( position = position_dodge())

full_dt %>% ggplot(aes(y=full_dt$Problem_Heatmap, color=full_dt$Same_Answer, fill=full_dt$Same_Answer))+geom_bar( position = position_dodge())

full_dt %>% ggplot(aes(y=full_dt$Problem_Human_Desc, color=full_dt$Same_Answer, fill=full_dt$Same_Answer))+geom_bar( position = position_dodge())
```
